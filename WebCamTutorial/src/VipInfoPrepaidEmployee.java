...
/**
 * Will show the VIP User('Prepaid') Informations
 */

public class VipInfoPrepaidEmployee {
	static int i = 0;
	private JFrame frame;
	String requestMessage = "vipinfoPrepaid";
	...
	JComboBox<String> system, userType;
	int value;
	 ...
	 */
	public VipInfoPrepaidEmployee(int n) {
		value = n;
		initialize();
	}
	...
	private void initialize() {
		...
		if (typeSelected == 0) {
			...
			frame.setVisible(false);
			new VipInfoPostpaidEmployee(value);
		}
