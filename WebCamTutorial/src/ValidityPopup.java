...
/**
 * This page will set the time for each type of vehicle how much time they can
 * stay in the parking after the payment is done. It will save the time in
 * minutes
 */
public class ValidityPopup extends LoginSession {

	private JFrame frame;
	String requestMessage = "validity";
	...
	private void initialize() {
		...
		JLabel lblBikeMin = new JLabel("Min");
		lblBikeMin.setBounds(310, 47, 20, 26);
		...
		JLabel lblCarMin = new JLabel("Min");
		lblCarMin.setBounds(310, 99, 20, 26);
		...
		JLabel lblMiniMin = new JLabel("Min");
		lblMiniMin.setBounds(310, 160, 20, 26);
